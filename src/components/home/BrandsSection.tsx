    ...
    <section className="py-14 md:py-20 bg-background">
      <div className="container">
        ...
        <div className="md:hidden space-y-4">
          <Link href="/brands/kama" className="relative block rounded-[28px] bg-[#014ea3] h-[220px] overflow-hidden transition-transform duration-500 ease-out hover:scale-[1.02] focus-visible:scale-[1.02]">
          ...
          <Link href="/brands/kinwin" className="relative block rounded-[28px] bg-[#e9821a] h-[220px] overflow-hidden transition-transform duration-500 ease-out hover:scale-[1.02] focus-visible:scale-[1.02]">
          ...
          <Link href="/brands/kinwin" className="relative block rounded-[28px] bg-black min-h-[300px] overflow-hidden transition-transform duration-500 ease-out hover:scale-[1.02] focus-visible:scale-[1.02]">
        ...
        <div className="relative hidden md:block mx-auto w-full max-w-[1280px] aspect-[943/635] bg-white overflow-hidden">
          ...
          >
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={figmaAssets.kamaVan} alt="Kama van" className="pointer-events-none absolute z-10 object-contain" style={{ left: "22.532%", top: "26.02%", width: "84.664%", height: "74%" }} />
          </Link>
          ...
          >
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={figmaAssets.coaster} alt="CHTC coaster" className="pointer-events-none absolute z-10 object-contain" style={{ left: "47.319%", top: "15.38%", width: "54.078%", height: "102.4%" }} />
          </Link>
          ...
          >
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={figmaAssets.kinwinBusSide} alt="Kinwin bus side" className="pointer-events-none absolute z-10 object-contain" style={{ left: "42.55%", top: "33.209%", width: "62.691%", height: "76.221%" }} />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={figmaAssets.kinwinBusFront} alt="Kinwin bus front" className="pointer-events-none absolute z-20 object-contain" style={{ left: "-5.72%", top: "24.528%", width: "57.329%", height: "102.263%" }} />
          </Link>
        </div>
      </div>
    </section>
