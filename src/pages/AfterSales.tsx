  ...
  <Layout>
    <section className="py-16 bg-kama-gradient">
      <div className="container text-center">
        ...
        <p className="text-primary-foreground/70 max-w-xl mx-auto">Spare parts, scheduled maintenance, warranty information, and service appointments.</p>
      </div>
    </section>
    ...
    <section className="py-16 bg-muted">
      <div className="container text-center">
        ...
        <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground font-display font-semibold text-sm uppercase tracking-wider rounded-sm hover:bg-kama-blue-dark transition-colors">
          Contact Us
        </Link>
      </div>
    </section>
